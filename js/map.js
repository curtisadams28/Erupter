...
let query = [];
const key =
  "pk.eyJ1IjoiY3VydHV4ZGVsdXhlIiwiYSI6ImNqd2s0MmZpZTBjajQ0OG9lZjQ1cWswbzIifQ.qqwt65rirh2anE7ykAn2hw";
...
function jsonToArray() {
  ...
  for (let i = 0; i < data.eruptions.length; i++) {
    if (
      data.eruptions[i].Year >= yearquery1 &&
      data.eruptions[i].Year <= yearquery2
    ) {
